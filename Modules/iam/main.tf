...
# -- IAM Role for ALB Worker Nodes ---
resource "aws_iam_role" "alb_worker_role" {
  name = "eks-alb-worker-role"
...
resource "aws_iam_role_policy_attachment" "alb_worker_policies" {
  for_each = toset([
  ...
  role       = aws_iam_role.alb_worker_role.name
